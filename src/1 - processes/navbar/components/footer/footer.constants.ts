...
export const APPLE_LINKS: { link: string; text: string }[] = [
  { link: 'https://www.apple.com/legal/privacy/en-ww/', text: 'Privacy Policy' },
  { link: 'https://www.apple.com/legal/internet-services/terms/site.html', text: 'Terms of Use' },
  { link: 'https://www.apple.com/shop/open/salespolicies', text: 'Sales and Refunds' },
  { link: 'https://www.apple.com/legal/', text: 'Legal' }
];
